...
$scope.searchSelected=function(selected){var title=encode(selected.originalObject.name),category=selected.originalObject.category;// Check which category is selected (room or class) to update the url
